...
func createTestState() *projects.StandardProjectState {
	...
	return &projects.StandardProjectState{
		Statechart: struct {
			Current_state string `json:"current_state"` //nolint:revive // Must match generated CUE type
		}{
		...
		Project: struct {
			...
			Github_issue  *int64     `json:"github_issue,omitempty"`  //nolint:revive // Must match generated CUE type
			Created_at    time.Time  `json:"created_at"`  //nolint:revive // Must match generated CUE type
			Updated_at    time.Time  `json:"updated_at"`  //nolint:revive // Must match generated CUE type
		}{
			Type:        "standard",
			Name:        "test-project",
			Branch:      "feat/test",
