...
func createTestState() *projects.StandardProjectState {
	...
	return &projects.StandardProjectState{
		...
		Phases: struct {
			Discovery      phasesSchema.DiscoveryPhase      `json:"discovery" yaml:"discovery"`
			Design         phasesSchema.DesignPhase         `json:"design" yaml:"design"`
			Implementation phasesSchema.ImplementationPhase `json:"implementation" yaml:"implementation"`
			Review         phasesSchema.ReviewPhase         `json:"review" yaml:"review"`
			Finalize       phasesSchema.FinalizePhase       `json:"finalize" yaml:"finalize"`
		}{
