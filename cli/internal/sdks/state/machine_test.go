...
func TestMachine_InitialState(t *testing.T) {
	...
	builder := NewBuilder(initialState, projectState, generator)
...
func TestMachine_Branching(t *testing.T) {
	...
	builder2 := NewBuilder(stateA, projectState, generator)
	...
	machine2 := builder2.SuppressPrompts(true).Build()
...
func TestMachine_DiamondPattern(t *testing.T) {
	...
	builder2 := NewBuilder(stateA, &schemas.ProjectState{}, generator)
...
func buildComplexWorkflowMachine(
	...
	builder := NewBuilder(stateNoProject, projectState, generator)
	...
	return builder.SuppressPrompts(true).Build()
}
...
func TestMachine_ComplexWorkflow(t *testing.T) {
	...
	guards := &complexWorkflowGuards{}
	machine := buildComplexWorkflowMachine(projectState, generator, guards)
