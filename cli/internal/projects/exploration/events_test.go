...
func TestEventsAreCorrectType(t *testing.T) {
	tests := []struct {
		...
		{"EventBeginSummarizing", EventBeginSummarizing},
		{"EventCompleteSummarizing", EventCompleteSummarizing},
...
func TestEventValues(t *testing.T) {
	tests := []struct {
		...
		{"EventBeginSummarizing", EventBeginSummarizing, "begin_summarizing"},
		{"EventCompleteSummarizing", EventCompleteSummarizing, "complete_summarizing"},
		{"EventCompleteFinalization", EventCompleteFinalization, "complete_finalization"},
	}
...
func TestAllEventsAreDifferent(t *testing.T) {
	...
	if len(seen) != 3 {
		t.Errorf("Expected 3 unique events, got %d", len(seen))
	}
}
...
func TestEventNamingConvention(t *testing.T) {
	tests := []struct {
		...
		{"EventBeginSummarizing uses snake_case", EventBeginSummarizing},
		{"EventCompleteSummarizing uses snake_case", EventCompleteSummarizing},
